# @omegion1npm/earum-tenetur-debitis(函数库)
...
npm install @omegion1npm/earum-tenetur-debitis --save
...
## 如何使用
``` language
import { deepCopy } from '@omegion1npm/earum-tenetur-debitis';
```
``` language
const obj = {
  aa: 1,
...
git仓库连接：https://github.com/omegion1npm/earum-tenetur-debitis
